      ...
      <div className="hidden sm:flex items-center gap-8">
...

        {
          <div className="hidden lg:flex items-center text-sm gap-2 border border-gray-300 px-3 rounded-full">
            ...
            />
            <img src={assets.search_icon} alt="search" className="w-4 h" />
          </div>
        }
        ...
        >
          ...
          {!user ? (
            <button
              ...
              className="cursor-pointer px-8 py-2 mt-2 bg-primary hover:bg-primary-dull transition text-white rounded-full"
            >
              Login
            </button>
          ) : (
